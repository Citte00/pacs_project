...
namespace pacs {
     ...
     * @return Vector<Real> 
     */
    Vector<Real> forcingFKPP(const Mesh &mesh, const TriFunctor &Alpha, const TriFunctor &D, const SourceFunctor &source, const TriFunctor &dirichlet, const Real &t, const Real &penalty_coefficient) {
