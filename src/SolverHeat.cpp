...
namespace pacs {
    ...
    Vector<Real> HeatSolver(const Mesh &mesh, const size_t &degree, const std::array<Sparse<Real>, 3> &Matrices, const Vector<Real> &c_old, const std::array<Vector<Real>, 2> &forcing, const Real &dt, const Real &theta, const Real &TOL) {
        // Mass blocks.
